...
[System.Serializable]
public class DataSoalMatematika
{
    public string soal;
...
public class SoalMatematika : MonoBehaviour
{
    public Text teksSoal;
    public Button tombolA, tombolB, tombolC, tombolD;

    public DataSoalMatematika[] daftarSoal;
    ...
    private UIMatematika uiMatematika;

    void Start()
    {
        mapelDipilih = PlayerPrefs.GetString("mapelDipilih", "Matematika");
        ...
        TampilkanSoal();
        uiMatematika = FindObjectOfType<UIMatematika>();
    ...
    void PeriksaJawaban(int jawaban)
    {
        ...
        else
        {
            ...
            if (uiMatematika != null)
            {
                uiMatematika.KurangiNyawa();
