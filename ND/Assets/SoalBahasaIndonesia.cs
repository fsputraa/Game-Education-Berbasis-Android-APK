...
[System.Serializable]
public class DataSoalBahasaIndonesia
{
    public string soal;
...
public class SoalBahasaIndonesia : MonoBehaviour
{
    public Text teksSoal;
    public Button tombolA, tombolB, tombolC, tombolD;

    public DataSoalBahasaIndonesia[] daftarSoal;
    ...
    private UIBahasaIndonesia uiBahasaIndonesia;

    void Start()
    {
        mapelDipilih = PlayerPrefs.GetString("mapelDipilih", "BahasaIndonesia");
        ...
        TampilkanSoal();
        uiBahasaIndonesia = FindObjectOfType<UIBahasaIndonesia>();
    ...
    void PeriksaJawaban(int jawaban)
    {
        ...
        else
        {
            ...
            if (uiBahasaIndonesia != null)
            {
                uiBahasaIndonesia.KurangiNyawa();
